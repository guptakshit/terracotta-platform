...
public class ActivateCommand1x2IT extends DynamicConfigIT {
  ...
  public void testFailedActivationWithReplicaNode() {
    ...
    assertThat(
      ...
      allOf(not(successful()), containsOutput("Nodes with names: [node-1-1] have replica-mode enabled. A cluster cannot be activated if replica-mode is enabled on any node.")));
  }
}
