  ...
  public void unset_relay() {
    ...
    assertThat(
      ...
      allOf(is(not(successful())),
        containsOutput("The relay setting is enabled for node with name: node-1-1, relay properties: {replica-hostname=null, replica-port=9410} aren't well-formed, [replica-hostname, replica-port] need to be set together"))
    );
